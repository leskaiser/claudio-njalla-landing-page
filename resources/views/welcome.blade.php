...
<!-- the Narvigation bar and Header -->
        ...
        <section class="bg-white py-24 dark:bg-gray-900">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8"> <!-- Section Header -->
                ...
                <div class="mt-16 text-center">
                    <a href="features.html" class="inline-flex items-center gap-2 text-primary-600 transition-colors hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
